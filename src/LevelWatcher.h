...
#define STATUSLED D4 //xxxD0, D1 used fro I2C,  D6 and D7 used for debugger.  Use D7 for release version.
...
const  int INNER_LOOP_DELAY_COUNT = 1;  // xxxDefault loop count - each inner loop takes 10s:  60 == 10min, 360 == 1h
...
const int INNER_LOOP_BLINK_FREQUENCY = 3; //
